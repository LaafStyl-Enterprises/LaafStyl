    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        <div className="flex flex-col items-center gap-1 text-center">
          <h1 className="text-2xl font-bold">{isSignup ? "Sign up for an account" : "Login to your account"}</h1>
        ...
        <Field>
          ...
          <FieldDescription className="text-center">
            ...
            <a href="#" className="underline underline-offset-4" onClick={isSignup ? handleLogin : handleSignup}>
